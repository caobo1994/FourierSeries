...
\begin{description}
\mitem{BasicEnv} The module that provides the infrastructure of the library. Part of the implementing languages' run-time libraries.
...
% List of modules
% \mref{BasicEnv}, \mref{DataDef}, \mref{Conversion}, \mref{Transformation}, \mref{BasicOp}, \mref{AdvancedOp}, \mref{LinearSolver}, \mref{Integral} 
...
{Hardware-Hiding Module} & \mref{BasicEnv} (hardware-related part, external)\\
\midrule
...
& \mref{BasicEnv} (software-related part, external)\\
\bottomrule
...
\subsection{Infrastructure module (\mref{BasicEnv})}
...
R3 & \mref{BasicEnv}, \mref{DataDef}, \mref{Conversion}, \mref{Transformation}, \mref{BasicOp}, \mref{AdvancedOp}, \mref{LinearSolver}, \mref{Integral}\\
R4 & \mref{LinearSolver}, \mref{Integral}, \mref{Transformation}, \mref{BasicOp}, \mref{AdvancedOp}\\
R5 & \mref{BasicEnv},  \mref{LinearSolver}, \mref{Integral}, \mref{DataDef},\\
\bottomrule
\end{tabular}
...
\midrule
\acref{HardwareOS} & \mref{BasicEnv}, \mref{DataDef}\\ 
