...
For simplicity, the sequence of type \li{T} will be abbreviated as seq(\li{T}), while that with dimensions $[l_1, ..., l_n]$ as seq(\li{T}, $l_1, ..., l_n$). Furthermore, we use both \li{Var: Type} and \li{Type Var} to indicate that variable \li{Var} is of type \li{Type}. 
...
\begin{center}
	...
	\end{tabular}
\end{center}
For convenience, we may use \li{A(i)} and \li{B(i)} to represent \li{getAi(i)} and \li{getBi(i)}, respectively.
