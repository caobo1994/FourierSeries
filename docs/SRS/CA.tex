...
and must have corresponding Fourier series. \wss{I think you use this assumption
  ...
  point is part of the SRS checklist.}
...
must be the same.  \wss{Is this an assumption, or is it something that you can
...
CFS's in \iref{IM:ConvertTo} and \iref{IM:ConvertFrom}. \wss{This assumption
